  ...
  return (
    <div className='pb-8 flex justify-between items-center'>
      ...
      {urlToNew && (
        ...
        >
          <RiAddLine />
          <p className='absolute bg-white whitespace-nowrap z-[2] invisible group-hover:visible group-active:opacity-0 text-xs bottom-[-40px] py-1 px-2 border-black border-[1px]'>
            {titleToNew}
          </p>
        </Link>
      )}
